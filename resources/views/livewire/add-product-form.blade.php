<div class="row">
    <div class="text-center mb-2">
        ...
        <div class="col-md-6" style="margin: auto;">
            <form class="row gy-1 pt-75" wire:submit.prevent="add">
                ...
                <div class="col-12 text-center mt-2 pt-50"  wire:loading.remove wire:target="images">
                    <button type="submit"  wire:loading.remove wire:target="add"  class="btn btn-primary me-1">Add item</button>
                    <button type="submit"  wire:loading wire:target="add"  class="btn btn-primary me-1"><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span></button>
